...
const toastStyles = {
  ...
  warning: {
    ...
    iconSvg: <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM10 15a1 1 0 1 1 0-2 1 1 0 0 1 0 2Zm1-4a1 1 0 0 1-2 0V6a1 1 0 0 1 2 0v5Z" />,
  },
};
...
export const Toast: React.FC<ToastProps> = ({ type, message, onClose }) => {
  ...
  return (
    <div
      ...
      role="alert">
      <div className={cn("inline-flex items-center justify-center shrink-0 w-8 h-8 rounded-lg", style.iconBg, style.iconColor)}>
